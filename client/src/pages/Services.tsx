...
const pricingTable = [
  ...
  { level: "Senior", experience: "3–5 years", hourly: "$65 – $120/hr", small: "$2,000 – $6,000", large: "$6,000 – $20,000" },
  { level: "Expert / Specialist", experience: "5+ years", hourly: "$120 – $200+/hr", small: "$5,000+", large: "$20,000+", highlight: true },
];
        ...
        <div className="mb-20 sm:mb-24 bg-card border border-border rounded-2xl p-4 sm:p-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5">
            {pricingRules.map((rule, i) => (
              <div key={i} className="flex items-start gap-3 text-xs sm:text-sm text-muted-foreground leading-relaxed">
