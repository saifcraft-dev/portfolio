...
const paymentStructure = [
  { icon: "💳", size: "Under $1,500",       structure: "100% upfront" },
  { icon: "✌️", size: "$1,500 – $3,500",   structure: "50% upfront · 50% on delivery" },
  { icon: "📐", size: "$3,500 – $10,000",  structure: "33% upfront · 33% midpoint · 33% delivery" },
  { icon: "🚀", size: "$10,000+",           structure: "40% upfront · 30% milestone · 30% delivery" },
