...
const pricingTable = [
  ...
  { level: "Senior", experience: "5+ years", hourly: "$65 – $120/hr", small: "$2,000 – $6,000", large: "$6,000 – $20,000", highlight: true },
  { level: "Expert / Specialist", experience: "7+ years", hourly: "$120 – $200+/hr", small: "$5,000+", large: "$20,000+" },
];
