    ...
    items: [
      {
        ...
        a: "It depends on scope. A landing page starts at $1,500. A full business website typically runs $3,500–$6,000. A custom web application (React + Node.js + PostgreSQL) starts at $5,000 and goes up depending on complexity. See the full pricing breakdown on the Services page.",
      },
      {
        q: "Do you require a deposit?",
        a: "Yes — always. For projects under $1,500, I collect 100% upfront. For larger projects, I collect 33–50% upfront before starting. This is standard practice and protects both of us. Serious clients respect payment terms; problematic ones push back on them — which is a useful early warning sign.",
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Yes. All projects include 30 days of free post-launch support for bug fixes. After that, I offer monthly retainer packages starting at $950/month that cover bug fixes, updates, security patches, and priority response time.",
      },
      {
