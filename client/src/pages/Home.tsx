          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center">
            ...
            >
              ...
              <p className="text-sm sm:text-base text-muted-foreground leading-relaxed mb-5">
                I'm a freelance fullstack developer building web applications from scratch. I've worked with early-stage startups, growing businesses, and local companies — always focused on clean code and measurable outcomes.
              </p>
              <p className="text-sm sm:text-base text-muted-foreground leading-relaxed mb-5">
