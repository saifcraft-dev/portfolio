                ...
                <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3">
                  ...
                  <div className="flex flex-wrap gap-1.5 sm:gap-2 pl-4 sm:pl-0">
                    {cat.skills.map((tech) => (
                      <div
                        key={tech.name}
                        className="inline-flex items-center gap-1.5 bg-white border border-border rounded-lg px-2.5 py-1.5 hover:border-primary/40 hover:bg-indigo-50 transition-all duration-150 cursor-default"
